          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`group relative overflow-hidden rounded-2xl border p-2.5 text-center transition duration-200 sm:p-3 sm:text-left ${
                  isActive
              ...
              {dojoDrills.map((drill) => (
                ...
                >
                  ...
                  <div className="mt-5 grid gap-4 lg:grid-cols-2">
                    <div className="rounded-2xl border border-sky-300/15 bg-sky-300/5 p-3 sm:p-4">
                ...
                <div className="grid gap-5">
                  {secretFlowcharts.map((flow) => (
                    ...
                    >
                      ...
                      <div className="mt-4 rounded-2xl border border-amber-300/15 bg-amber-300/5 p-3 sm:p-4">
                        <p className="text-xs font-semibold uppercase tracking-[0.28em] text-amber-600">
                          If they adapt
                        </p>
                        <p className="mt-3 text-sm leading-6 text-slate-600">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4">
              {secretHabits.map((habit) => (
                <article
                  key={habit.title}
                  className="rounded-3xl border border-slate-200 bg-white/85 p-4 sm:p-6"
                >
      ...
      {activeTab === "matchups" ? (
        <section className="space-y-6">
          ...
          {activeMatchup ? (
            ...
            >
              <article className="rounded-3xl border border-rose-300/20 bg-white/85 p-4 sm:p-8">
                ...
                <div className="mt-5 rounded-2xl border border-slate-200 bg-white/80 p-4 sm:p-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.28em] text-rose-600">
                    Quick read
                  </p>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-emerald-300/20 bg-emerald-300/5 p-4 sm:p-5">
                  ...
                  <div className="rounded-2xl border border-sky-300/20 bg-sky-300/5 p-4 sm:p-5">
                  ...
                  <div className="rounded-2xl border border-amber-300/20 bg-amber-300/5 p-4 sm:p-5">
                  ...
                  <div className="rounded-2xl border border-rose-300/20 bg-rose-300/5 p-4 sm:p-5">
